...
prob = function(R1,N1,R2,N2,time,stage_2){
low = 0
high = 1
mid = 0.5
midleft = 0.25
...
T=seq(0,4000,by=500)
Optimal.P.ctrl.2 = rep(NA,length(T))
for(i in 1:length(T)){
Optimal.P.ctrl.2[i] = prob4(31,102,29,102,T[i],100)
print(i)
}
Optimal.P.ctrl.2
...
dat = t(dat)
matplot(T,dat,xlab = "F",ylab = "Optimal P_ctrl", type = c("l"),pch=1,lwd =3) #plot
legend("topright", legend = c("VFR_Binomial","VFR_Normal"), col=1:2, lty=1) # optional legend
