crtrate_random = rep(NA,itertimes)
exp_reg_random = rep(NA,itertimes)
post_reg_random = rep(NA,itertimes)
sum_reg_random = rep(NA,itertimes)
...
crtrate_random[ldai]=(sum(correct_rpm))
sum_reg_random[ldai]=(mean(rowSums(loss_rpm)+post_loss))
exp_reg_random[ldai]=(mean(rowSums(loss_rpm)))
post_reg_random[ldai]=(mean(post_loss))
}
