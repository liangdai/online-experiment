...
for(i in 1:num_time){
	prob_1 = prob4(alpha1_store[iter,1],alpha1_store[iter,1]+beta1_store[iter,1],alpha2_store[iter,1],alpha2_store[iter,1]+beta2_store[iter,1],(pos_time+num_time-i)*num_batch,num_batch)
